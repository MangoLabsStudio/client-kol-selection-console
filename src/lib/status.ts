...
const riskTagLabels: Record<string, string> = {
  ...
  research_academic_identity: "研究者/学术身份",
  smaller_reach: "覆盖规模较小",
  technical_depth_required: "需技术材料支撑",
  tool_roundup_or_prompt_risk: "工具号/提示词风险",
  vc_or_investor_identity: "VC/投资人身份",
...
const contactStatusLabels: Record<string, string> = {
  ...
  commercial_path_visible: "商务路径清楚",
  commercial_path_unconfirmed: "商务路径待验证",
  confirmed_or_obvious_contact: "商务入口清楚",
  creator_booking_visible: "创意合作入口清楚",
  "direct contact": "可直接联系",
  likely_paid_but_needs_bd: "可能可合作，需 BD",
  "manager contacted": "已联系团队",
  needs_bd_verification: "需 BD 验证",
  "needs conflict check": "需确认排他",
  "not contacted": "尚未联系",
  probable_media_or_creator_route: "媒体/Creator 路径",
...
const categoryLabels: Record<string, string> = {
  ...
  ai_media_newsletter: "AI 媒体 / Newsletter",
  ai_tools_education: "AI Tools / Education",
  "AI tooling": "AI 工具评测",
  broad_ai: "Broad AI",
  "Business / AI media": "商业 / AI 媒体",
  consumer_social_ai: "Consumer / Social AI",
  "Creative AI": "Creative AI",
  creative_ai: "Creative AI",
  deep_ai_discussion: "Deep AI Discussion",
